"""
Configuration settings for Kyber AI Assistant.
...
VIRTUAL_MOUSE_CAMERA_INDEX = int(os.getenv("VIRTUAL_MOUSE_CAMERA_INDEX", "0"))
...
LOG_FILE = os.path.join("logs", "kyber.log")
